...
$result=mysqli_query($koneksi, "SELECT * FROM member ORDER BY id_member ASC") or die(mysql_error());
...
$pdf->Cell(80);
$pdf->Cell(30,10,'DATA MEMBER',0,0,'C');
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(30,10,'List Data Member',0,0,'C');
$pdf->Ln();
...
$pdf->SetY($Y_Table_Position);
$pdf->SetX(155);
$pdf->MultiCell(50,6,$column_no_hp,1,'C');
