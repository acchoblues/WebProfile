...
$result=mysqli_query($koneksi, "SELECT * FROM teknisi ORDER BY id_teknisi ASC") or die(mysql_error());
...
$pdf->Cell(80);
$pdf->Cell(30,10,'DATA TEKNISI UD. KDU',0,0,'C');
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(30,10,'List Data Teknisi',0,0,'C');
$pdf->Ln();
