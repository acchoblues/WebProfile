...
<?php
			...
			if(isset($_POST['update'])){
				...
				$update = mysqli_query($koneksi, "UPDATE po SET no_po='$no_po', id_jenis='$id_jenis', id_member='$id_member', lokasi='$lokasi', rincian='$rincian', unit='$unit', qty='$qty', harga='$harga', tgl_order='$tgl_order', tgl_selesai='$tgl_selesai', status='$status'  WHERE id_order='$id_order'") or die(mysqli_error());
				if($update){
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="id_order" type="text" id="id_order" class="form-control" autocomplete="off" value="<?php echo $row['id_order']; ?>" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                    ...
                    ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="lokasi" type="text" id="lokasi" class="form-control" autocomplete="off" value="<?php echo $row['lokasi']; ?>" required="required"/>
                              </div>
                          </div>
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="unit" type="text" id="unit" class="form-control" autocomplete="off" value="<?php echo $row['unit']; ?>" required="required"/>
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Qty</label>
                              <div class="col-sm-3">
                                  <input name="qty" type="text" id="qty" class="form-control" autocomplete="off" value="<?php echo $row['qty']; ?>" required="required"/>
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Harga</label>
                              <div class="col-sm-3">
                                  <input name="harga" type="text" id="harga" class="form-control" value="<?php echo $row['harga']; ?>" placeholder="Harga" required="required"/>
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Order</label>
                              <div class="col-sm-3">
                                  <input name="tgl_order" type="text" id="tgl_order" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" autocomplete="off" value="<?php echo $row['tgl_order']; ?>" required="required"/>
                              </div>
                          </div>
                           <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="status" type="text" id="status" class="form-control" autocomplete="off" value="<?php echo $row['status']; ?>" required="required"/>
                              </div>
                          </div>
                          <div class="form-group">
