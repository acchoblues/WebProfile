...
$result=mysqli_query($koneksi, "SELECT testimoni.*, member.nama_member FROM testimoni, member WHERE testimoni.id_member=member.id_member") or die(mysql_error());
...
$pdf->Cell(80);
$pdf->Cell(30,10,'DATA TESTIMONI MEMBER',0,0,'C');
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(30,10,'List Data Testimoni Member',0,0,'C');
$pdf->Ln();
