        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
             ...
             if(isset($_GET['hal']) == 'hapus'){
				$kd_produk = $_GET['kd'];
				$cek = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_produk='$kd_produk'");
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan.</div>';
				}else{
					$delete = mysqli_query($koneksi, "DELETE FROM produk WHERE id_produk='$kd_produk'");
					if($delete){
           ...
           <!-- /.row -->
	               ...
	               $qcari=$_POST['qcari'];
	               $query1="SELECT * FROM  produk 
	               where id_produk like '%$qcari%'
	               or nama_produk like '%$qcari%'  ";
                    }
                  ...
                  <thead>
                    ...
                    ?>
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Produk" href="edit-produk.php?hal=edit&kd_cus=<?php echo $data['id_produk'];?>"><span class="glyphicon glyphicon-edit"></span></a>  
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['nama_produk'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Produk" href="produk.php?hal=hapus&kd=<?php echo $data['id_produk'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
                ...
                <div class="text-right">
                  <a href="input-produk.php" class="btn btn-sm btn-warning">Input Produk <i class="fa fa-arrow-circle-right"></i></a>
