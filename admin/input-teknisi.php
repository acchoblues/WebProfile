            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Input Teknisi</li>
                    </ol>
                </section>
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO teknisi(id_teknisi,nama_teknisi,alamat,hp,username,password,gambar) VALUES
            ('$kode','$nama','$alamat','$no_telp','$username','$password','$gambar')";
			$res=mysqli_query($koneksi, $sql) or die (mysqli_error());
			//echo "Gambar berhasil dikirim ke direktori".$gambar;
            echo "<script>alert('Data Teknisi berhasil dimasukan!'); window.location = 'teknisi.php'</script>";	   
		} else {
	...
	echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Anda Belum Memilih Gambar.!</div>';
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Input Data Teknisi </h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-teknisi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Id Teknisi</label>
                              <div class="col-sm-8">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="no_telp" type="text" id="no_telp" class="form-control" autocomplete="off" placeholder="No Handphone" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="teknisi.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                  </div>
