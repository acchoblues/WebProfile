           ...
           <!-- /.row -->
            ...
            ?>
                  ...
                  <div class="form-panel">
                      ...
                      <td width="575"><?php echo $data['username']; ?></td>
                      <td rowspan="6"><div class="pull-right image">
                            <img src="<?php echo $data['gambar']; ?>" class="img-rounded" height="300" width="200" alt="User Image" style="border: 2px solid #666;" />
                        </div></td>
                      </tr>
                      <tr>
                      <td>Password</td>
                      <td colspan="1"><?php echo $data['password']; ?></td>
                      </tr>
                      <tr>
                      <td>Fullname</td>
                      ...
                      <tr>
                      <td>Handphone</td>
                      <td colspan="1"><?php echo $data['hp']; ?></td>
                      </tr>
                      </table>
