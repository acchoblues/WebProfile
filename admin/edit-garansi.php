...
<?php
            $kd = $_GET['kd_cus'];
			$sql = mysqli_query($koneksi, "SELECT * FROM garansi WHERE id_garansi='$kd'");
			...
			if(isset($_POST['update'])){
				...
				$update = mysqli_query($koneksi, "UPDATE garansi SET id_member='$id_member', no_po='$no_po', tgl_order='$tgl_order', tgl_expire='$tgl_expire', masa='$masa', status='$status' WHERE id_garansi='$id_garansi'") or die(mysqli_error());
				if($update){
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Edit Garansi</h3> 
                        </div>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="id_garansi" type="text" id="id_garansi" class="form-control" autocomplete="off" placeholder="Autonumber" value="<?php echo $row['id_garansi']; ?>" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <label class="col-sm-2 col-sm-2 control-label">Expire Sebelumnya</label>
                              <div>
                              <h4><span class="label label-info"><?php echo $row['tgl_expire']; ?></span></h4>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  ...
                                  <label class="col-sm-2 col-sm-2 control-label">Garansi Sebelumnya</label>
                              <div>
                              <h4><span class="label label-success"><?php echo $row['masa']; ?></span></h4>
                              </div>
                          </div>
                          <div class="form-group">
