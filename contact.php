...
<div class="col-md-4">
                <h3>Detail Kontak</h3>
                <p>
                    <b>UD. Kencana Daya Utama</b>
                </p>
                <p><i class="fa fa-road"></i> 
                    <abbr title="Phone"></abbr>:Jl.Kebo Iwa Selatam<br>Lingkungan Pandasari No.88, Seminyak - Bali</p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone"></abbr>: (0361) 9299108</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email"></abbr>: <a href="mailto:info@kde.co.id">info@kde.co.id</a>
                </p>
