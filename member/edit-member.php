...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php
            $kd = $_GET['kd_cus'];
			$sql = mysqli_query($koneksi, "SELECT * FROM member WHERE id_member='$kd'");
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="UPDATE member SET nama_member='$nama', alamat='$alamat', no_telp='$no_telp', email='$email', username='$username', password='$password', gambar='$gambar' WHERE id_member='$kode'" or die(mysqli_error());
			$res=mysqli_query($koneksi, $sql) or die (mysqli_error());
			//echo "Gambar berhasil dikirim ke direktori".$gambar;
            echo "<script>alert('Data member berhasil diupdate!'); window.location = 'member.php'</script>";	   
		} else {
	...
	echo "Anda belum memilih gambar";
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Edit Data Member </h3> 
                        </div>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="id" type="text" id="id" value="<?php echo $row['id_member']; ?>" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                              <div class="col-sm-3">
                            <input name="nama" type="text" id="nama" value="<?php echo $row['nama_member']; ?>" class="form-control" autocomplete="off" placeholder="Nama" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="email" type="email" id="email" value="<?php echo $row['email']; ?>" class="form-control" autocomplete="off" placeholder="Email" autocomplete="off" required="required" />
