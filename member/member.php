        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <?php
                    $query1="select * from member where id_member='$_SESSION[user_id]'";
                  ...
                  <thead>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Edit Member" href="edit-member.php?hal=edit&kd_cus=<?php echo $data['id_member'];?>"><span class="glyphicon glyphicon-edit"></span></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
