                  ...
                  <div class="form-panel">
                    ...
                    ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="id_member" type="text" id="id_member" class="form-control" autocomplete="off" value="<?php echo $_SESSION['user_id']; ?>" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="unit" type="hidden" id="unit" class="form-control" autocomplete="off" placeholder="Unit" required="required"/>
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"></label>
                              <div class="col-sm-3">
                                  <input name="qty" type="hidden" id="qty" class="form-control" autocomplete="off" placeholder="Qty" required="required"/>
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"></label>
                              <div class="col-sm-3">
                                  <input name="harga" type="hidden" id="harga" class="form-control" autocomplete="off" placeholder="Harga" required="required"/>
                              </div>
                          </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"></label>
                              <div class="col-sm-3">
                                  <input name="tgl_selesai" type="hidden" id="tgl_selesai" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Tanggal Selesai" required="required"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"></label>
                              <div class="col-sm-3">
                                  <input name="status" type="hidden" id="status" class="form-control" autocomplete="off" placeholder="Status" required="required"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"></label>
