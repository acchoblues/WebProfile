        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Data Detail Member </h3> 
                        </div>
                        <?php
                    $query = mysqli_query($koneksi, "SELECT * FROM member WHERE id_member='$_GET[kd]'");
                    ...
                    <td width="550"><?php echo $data['nama_member']; ?></td>
                    </tr>
                    <tr>
                    <td>Alamat</td>
