            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
                            <?php $tampil=mysqli_query($koneksi, "select * from member order by id_member desc");
                    ...
                    ?>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
                            <?php $tampil1=mysqli_query($koneksi, "select * from teknisi order by id_teknisi desc");
                    ...
                    ?>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
                            <?php $tampil2=mysqli_query($koneksi, "select * from jadwal_proyek order by id_jadwal desc");
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>Tanggal Proyek</i></center></th>
                    ...
                    <td><center> <?php //echo number_format($data['harga'],2,",",".");
              ...
              ?>
                ...
                <div class="text-right">
                  <a href="jadwal.php" class="btn btn-sm btn-primary">Lihat Jadwal <i class="fa fa-arrow-circle-right"></i></a>
                       ...
                       <!-- <div class="table-responsive"> -->
                    <?php
                    $query2="select * from admin order by user_id desc limit 5";
                  ...
                  <thead>
                    ...
                    <tr>
                    <td><center><?php echo $no; ?></center></td>
                    <td><a href="detail-admin.php?hal=edit&kd=<?php echo $data1['user_id'];?>"><span class="glyphicon glyphicon-user"></span> <?php echo $data1['fullname']; ?></a></td>
                    <td><center><?php echo $data1['hp']; ?></center></td>
                    <!--<td><center><?php 
